...
Bagoyos, Ira Louise B.

Ramos, Louella Amor C.

Reyes, Joanna Hyacinth M.
"""
...
"""This dataset contains 20000 customer's ID, purchase information, their purchases and their ratings"""

df.isna().sum()

"""This table shows how many either didn't disclose their gender or if they purchased any add-ons. So far, there's only 1 who didn't disclose their gender and 4868 people didn't purchase add-ons."""

df.describe()

"""The categorical values are Gender, Loyalty Member, Product Type, SKU, Order Status, Payment Method, Shipping Type, Purchase Date, Add-ons Purchased.

The numerical values are Age, Rating, Total Price, Unit Price, Quantity, Add-on Total.
"""
...
**[Ramos]** - Percentages of Male and Female Loyalty Members
"""
...
"""As can be seen in these pie charts, the percentages of male and female loyalty members are almost exactly similar, with there being 21.67% and 21.75% loyalty members in male and female demographics respectively.

**[Ramos]** - Total Price by Age
"""
